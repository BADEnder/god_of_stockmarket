...
const checkout_stock_id_type = (stock_id_sets) => {
...
const handle_stock_id_to_data = async (stock_id) => {
    let result = []
    stock_id_sets = checkout_stock_id_type(stock_id)
...
const postStockMartketData = async(req, res) => {
    ...
    handle_stock_id_to_data(stock_id)
    .then(data => {
